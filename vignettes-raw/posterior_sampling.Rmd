...
We start by fitting a semiparametric modeling with factor structures described in the vignette on [semiparametric latent variable modeling](https://docs.ropensci.org/galamm/articles/mixed_response.html). To make it more interesting we only keep the first 10 subjects.
